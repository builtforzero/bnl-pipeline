...
class Utils {
    ...
    clean(value) {
        const cleanedValue = value.toString().replace(/[^A-Z0-9]/ig, "").toLowerCase().trim()
        return cleanedValue;
    }
    ...
    valueIsNull = (element) => {return element === null || element === ""}

    valueIsNotNull = (element) => {return element != null && element != ""}

    valueIsFalse = (element) => {return element === false}

    valueIsTrue = (element) => {return element === true}
